...
export let listUsers = [
  {
    ...
    selectSkills:  ['HTML','CSS','Javascript','React','Angular','jQuery','NodeJS','Python','PHP','Ruby On Rails','SQL',
      'BackboneJS','Web Design','Project management','Git','Docker','AWS Lambda','Firebase',],
  ...
  },
  {
    ...
    selectSkills: ['Skill 1, Skill 2, Skill 3, Skill 4, Skill 5, Skill 6, Skill 7, Skill 8',
